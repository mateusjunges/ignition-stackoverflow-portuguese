...
<script>
    ...
    export default {
        ...
        computed: {
            url: function () {
                return 'https://pt.stackoverflow.com/search?q=' + encodeURIComponent(this.query);
            }
        },
        methods: {
            prevPage: function () {
            ...
            search: function () {
                ...
                axios
                    .get('https://api.stackexchange.com/2.2/search/advanced?&pagesize=10&order=desc&sort=relevance&site=pt.stackoverflow&answers=1&page='+this.page+'&q='+encodeURIComponent(this.query))
                    .then(response => {
